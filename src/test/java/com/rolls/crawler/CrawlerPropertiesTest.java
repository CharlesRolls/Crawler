...
public class CrawlerPropertiesTest
{
   ...
   public void testNull()
   {
      ...
      assertThat(props, allOf(
            ...
            hasProperty("crawlTimeoutSeconds", is(CrawlerProperties.MIN_CRAWL_TIMEOUT_SECONDS))
            ));
   }
   ...
   public void testInvalidAll()
   {
      ...
      props.setCrawlTimeoutSeconds(CrawlerProperties.MIN_CRAWL_TIMEOUT_SECONDS - 1);
   ...
   public void testOutputPathExistNonDir() throws IOException
   {
      ...
      props.setCrawlTimeoutSeconds(CrawlerProperties.MIN_CRAWL_TIMEOUT_SECONDS);
